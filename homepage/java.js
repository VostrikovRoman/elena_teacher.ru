...
function Copy() {
	const forCopyText = document.querySelector('.mail');
	const forCopyText2 = document.getElementById('mail');
	forCopyText.onclick = function () {
...
function Copy2() {
	const forCopyText = document.querySelector('.phone');
...
function Video(video) {
	...
	var video_background = document.getElementById("video_back");
	video_block.src = video.src;
